...
mongoose.connect('mongodb+srv://chandrakumarreddyg:Gchandu1631990@cluster0.ed0axem.mongodb.net/?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true }).then(res=>{
    ...
    */
    ...
    else if (req.url==='/api')
    {
        ...
        try {
            ...
            const result = await client.db("Eateries").collection("Items").find({}).toArray();
